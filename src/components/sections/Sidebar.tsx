      ...
      <div className="space-y-6">
        <div>
          ...
          <div className={`inline-block px-3 py-1 rounded-full text-sm font-medium mb-4 ${
            ...
            selectedEntry.category === 'contact' ? 'bg-yellow-500/20 text-yellow-300 border border-yellow-500/30' :
            selectedEntry.category === 'skill-category' ? 'bg-blue-400/20 text-blue-300 border border-blue-400/30' :
            selectedEntry.category === 'skill-item' ? 'bg-cyan-400/20 text-cyan-300 border border-cyan-400/30' :
